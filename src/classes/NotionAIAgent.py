...
class NotionAIAgent:
    ...
    # Update a Page
    def update_page(self, page_id:str, update_data:dict[str, any]):
    ...
    def add_summary(self, database_id:str):
        try:
    ...
    def add_tags(self, database_id:str):
        try:
